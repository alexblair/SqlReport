---
module: report.py
contract_id: MOD-REPORT
version: 1.0
depends_on: [app_config, config_db, db, markdown_render, query_executor, redis_cache, render, result_transform, static_cache]
...
**`execute_report(report_id, sql_query, pool_config, page=1, page_size=20, sorts=None, filters=None, refresh=False, active_index=0, report=None, conn=None, cache=None, force_rebuild=False, read_timeout=None) -> ReportResult`**
...
- 每结果集独立执行 `filter_rows` → `sort_rows` → 分页。
